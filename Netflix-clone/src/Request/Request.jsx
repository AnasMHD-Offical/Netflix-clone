...
const Requests = {
    fetchTrending : `/trending/all/week?api_key=${API_KEY}&language=en&page=1`,
    fetchNetflixOrginals : `/discover/tv?api_key=${API_KEY}&include_adult=false&language=en-US&page=3&sort_by=popularity.desc&with_networks=213`,
    ...
    fetchDocumentaries : `/discover/movie?api_key=${API_KEY}&language=en&sort_by=popularity.desc&with_genres=99&page=2`,
